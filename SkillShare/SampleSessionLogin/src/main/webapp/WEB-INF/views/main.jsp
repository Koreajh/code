...
<head>
  ...
  <!-- AdminLTE App -->
  <script src="${pageContext.request.contextPath}/resources/js/adminLTE2/app.min.js"></script>
  <!-- Sparkline -->
  ...
  <script src="${pageContext.request.contextPath}/resources/js/adminLTE2/pages/dashboard2.js"></script>
  <!-- AdminLTE for demo purposes -->
  <script src="${pageContext.request.contextPath}/resources/js/adminLTE2/demo.js"></script>
</head>
