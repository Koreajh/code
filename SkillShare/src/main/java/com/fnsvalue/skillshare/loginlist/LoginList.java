package com.fnsvalue.skillshare.loginlist;
...
*/
	public class LoginList implements HttpSessionBindingListener{

		private static LoginList loginManager = null;
...
* 싱글톤 패턴 사용
*/
		public static synchronized LoginList getInstance(){
			if(loginManager == null){
				loginManager = new LoginList();
			}
			return loginManager;
		}
