...
//
//import com.fnsvalue.skillshare.bo.LogBO;
...
//	private LogBO logBO;
//	
//	@Pointcut("execution(* com.fnsvalue.skillshare.bo.BoardBO.boardAdd(..))")
//	public void insertCell(){}
//	
//	@Pointcut("execution(* com.fnsvalue.skillshare.bo.BoardBO.boardChange(..))")
//	public void updateCell(){}
//	
//	@Pointcut("execution(* com.fnsvalue.skillshare.bo.BoardBO.boardDelete(..))")
...
//		
//		Log log = new Log();
//		log.setLog_id(userId);
//		log.setLog_content(opContent);
//		log.setLog_operation("추가");
//		logBO.insertLog(log);
//	}
//	
//	 /** 
