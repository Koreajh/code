...
$(function(){
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <c:forEach var="row" items="${QuestionDetail}">
    <form action="questionChange" method="post" id="frm">
    <input type="hidden" name="ask_no_pk" id="ask_no_pk" value="${row.ask_no_pk}">
...
<div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">문의 제목 <input type="text" name="ask_tit" id="ask_tit" value="${row.ask_tit}"></h3>
     ...
     <textarea name="ask_con" id="ask_con" rows="10" cols="100" style="width:766px; height:412px;">${row.ask_con}</textarea>		
       ...
       <button type="submit" class="btn btn-primary fa fa-pencil" id="savebutton">수정</button>
